...
normalizations <- c("included", "removed")
...
D_list <- list(QN_72_48_ups, qn_72_48_ups)

file_name <- paste0(dir_plot, "venn_ncRNA_QN_72_48_up.png")
...
D_list <- list(QN_72_48_downs, qn_72_48_downs)

file_name <- paste0(dir_plot, "venn_ncRNA_QN_72_48_down.png")
...
D_list <- list(QN_120_72_ups, qn_120_72_ups)

file_name <- paste0(dir_plot, "venn_ncRNA_QN_120_72_up.png")
...
D_list <- list(QN_120_72_downs, qn_120_72_downs)

file_name <- paste0(dir_plot, "venn_ncRNA_QN_120_72_down.png")
...
D_list <- list(QN_adult_120_ups, qn_adult_120_ups)

file_name <- paste0(dir_plot, "venn_ncRNA_QN_adult_120_up.png")
...
D_list <- list(QN_adult_120_downs, qn_adult_120_downs)

file_name <- paste0(dir_plot, "venn_ncRNA_QN_adult_120_down.png")
