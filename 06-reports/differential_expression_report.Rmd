...
```{r}
load("TMM_tt_72_48.RData")
tabla(tt_72_48)
```

```{r}
knitr::include_graphics("TMM_volcano_72 hpf vs 48 hpf.png")
```

### 120 hpf vs 72 hpf

```{r}
load("TMM_tt_120_72.RData")
tabla(tt_120_72)
```

```{r}
knitr::include_graphics("TMM_volcano_120 hpf vs 72 hpf.png")
```

### Adult vs 120 hpf

```{r}
load("TMM_tt_Adult_120.RData")
tabla(tt_adult_120)
```

```{r}
knitr::include_graphics("TMM_volcano_Adult vs 120 hpf.png")
```
...
```{r}
load("QN_tt_72_48.RData")
tabla(tt_72_48)
```

```{r}
knitr::include_graphics("QN_volcano_72 hpf vs 48 hpf.png")
```

### 120 hpf vs 72 hpf

```{r}
load("QN_tt_120_72.RData")
tabla(tt_120_72)
```

```{r}
knitr::include_graphics("QN_volcano_120 hpf vs 72 hpf.png")
```

### Adult vs 120 hpf

```{r}
load("QN_tt_Adult_120.RData")
tabla(tt_adult_120)
```

```{r}
knitr::include_graphics("QN_volcano_Adult vs 120 hpf.png")
```
