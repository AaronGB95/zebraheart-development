...
write.xlsx2(tt_72_48$table[,c("logFC","FDR")], file = "data/results/72_vs_48_todos.xlsx")
write.xlsx2(tt_120_72$table[,c("logFC","FDR")], file = "data/results/120_vs_72_todos.xlsx")
write.xlsx2(tt_Adult_120$table[,c("logFC","FDR")], file = "data/results/Adulto_vs_120_todos.xlsx")

## Ups y Downs por separado

### Downs

write.xlsx2(tt_72_48$table[which(tt_72_48$table$logFC < -1.5 & tt_72_48$table$FDR < 0.05),c("logFC","FDR")], file = "data/results/72_vs_48_downs.xlsx")
write.xlsx2(tt_120_72$table[which(tt_120_72$table$logFC < -1.5 & tt_120_72$table$FDR < 0.05),c("logFC","FDR")], file = "data/results/120_vs_72_downs.xlsx")
write.xlsx2(tt_Adult_120$table[which(tt_Adult_120$table$logFC < -1.5 & tt_Adult_120$table$FDR < 0.05),c("logFC","FDR")], file = "data/results/Adulto_vs_120_downs.xlsx")

### Ups

write.xlsx2(tt_72_48$table[which(tt_72_48$table$logFC > 1.5 & tt_72_48$table$FDR < 0.05),c("logFC","FDR")], file = "data/results/72_vs_48_ups.xlsx")
write.xlsx2(tt_120_72$table[which(tt_120_72$table$logFC > 1.5 & tt_120_72$table$FDR < 0.05),c("logFC","FDR")], file = "data/results/120_vs_72_ups.xlsx")
write.xlsx2(tt_Adult_120$table[which(tt_Adult_120$table$logFC > 1.5 & tt_Adult_120$table$FDR < 0.05),c("logFC","FDR")], file = "data/results/Adulto_vs_120_ups.xlsx")
